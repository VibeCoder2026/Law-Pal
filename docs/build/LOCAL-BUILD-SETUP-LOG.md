...
├── app/
│   ├── src/main/assets/
│   │   └── law_sources/          # 761MB PDFs (copied by Gradle)
│   │       ├── civil-law/
│   │       ├── criminal-justice/
│   │       └── ... (all 459 Acts)
│   ├── build/                    # Compiled APK (~1GB, can delete)
│   └── build.gradle              # Modified by withLawSourcesAssets.js
├── gradle/                       # Gradle wrapper
└── build/                        # Build cache (~500MB)
```
...
- ❌ New native npm packages (e.g., `npm install @react-native-voice/voice`)
...
# Daily usage:
npx expo start --dev-client
# Make changes → Hot reload in 2-3 sec ⚡
```
...
# 4. Shake device → "Reload" or press 'r' in Metro
```
...
2. ✅ Test app opens and PDFs load
3. ✅ Test AI chat functionality
4. ✅ Test hot reload with simple change
...
- ✅ ADB accessible
- ✅ First local build initiated

### What You Get
- ✅ **Instant hot-reload** (2-3 sec vs 15 min)
- ✅ **Offline development** (no EAS uploads)
- ✅ **Unlimited builds** (no build minute limits)
- ✅ **Faster iteration** (rapid testing)

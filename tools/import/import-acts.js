...
const CATALOG_PATH = path.join(ROOT_DIR, 'law_sources', 'tiered-catalog.json');
const LAW_SOURCES_DIR = path.join(ROOT_DIR, 'law_sources');
const OUTPUT_PATH = path.join(ROOT_DIR, 'src', 'assets', 'acts-import.json');
